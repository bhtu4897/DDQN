...
import math
import os
import DoubleDQN_Implementation
...
def DRL_implementation(filename,globali):
    ...
    #        print('Routing net No.',sortedHalfWireLength[i][0])
        ...
        agent = DoubleDQN_Implementation.DoubleDQN_Agent(environment_name, sess, graphcase)   
    ...
    # if testing using training function, comment burn_in
        ...
        agent.replay = DoubleDQN_Implementation.Replay_Memory() #Remove memeory of previous training
